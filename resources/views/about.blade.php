...
.mini-card:hover {
    background: linear-gradient(135deg, #92b8e9ea 0%, #f5f7f8 100%);/* Bootstrap primary blue */
...
/* Ensure all inner text also turns white */
...
.step-number {
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="mainNavbar">
        <ul class="navbar-nav gap-lg-4 text-center text-lg-start">
          ...
          <li class="nav-item">
            <a class="nav-link active-nav " href="{{ route('about') }}">About</a>
          </li>
 ...
 <main>
  <section class="about-section d-flex align-items-center font-ui">
  <div class="container">
    <div class="row g-4 align-items-center">
      ...
      <div class="col-lg-6">
        <div class="glass-card p-4 p-md-5">
          ...
          <h2 class="fw-bold mb-3">We Bring Your Devices Back to Life</h2>
          <h6 class="text-muted mb-3 ">Fast • Reliable • Affordable Services</h6>

          <p class="mb-2">
            We specialize in professional repair services for phones, watches, shoes, locks, and leather goods.
          </p>
          <p class="mb-2">
      ...
      <div class="col-lg-6">
        <div class="glass-card highlight-card p-4 p-md-5 text-center text-lg-start">
          ...
          <div class="feature-item mb-3">
            <h6 class="fw-bold mb-1">⚡ Quick Turnaround</h6>
            <p class="mb-0 text-muted">Most repairs completed the same day.</p>
          </div>

          <div class="feature-item mb-3">
            <h6 class="fw-bold mb-1">🛠 Skilled Professionals</h6>
          ...
          <div class="feature-item">
            <h6 class="fw-bold mb-1">⭐ Trusted by Customers</h6>
...
<section class="commitment-section py-5 font-ui">
  <div class="container">
    <div class="row justify-content-center text-center ">
      <div class="col-lg-8 slide-left">
        <h2 class="fw-bold mb-3">Our Commitment to Quality</h2>
    ...
    <div class="row text-center mt-5 g-4 font-ui">
      ...
      <div class="col-md-4">
        <div class="mini-card p-4 h-100">
          <h6 class="fw-bold fs-3">Attention to Detail</h6>
      ...
      <div class="col-md-4">
        <div class="mini-card p-4 h-100">
          <h6 class="fw-bold fs-3">Professional Standards</h6>
      ...
      <div class="col-md-4">
        <div class="mini-card p-4 h-100">
          <h6 class="fw-bold fs-3">Customer Satisfaction</h6>
  ...
  <section class="process-section py-5 commitment-section">
  <div class="container font-ui">
    <h2 class="text-center fw-bold mb-5">Our Repair Process</h2>
    ...
    <div class="row text-center g-4">
      ...
      <div class="col-md-3">
        <div class="process-step p-3">
          ...
          <h6 class="fw-bold mt-3">Inspection</h6>
      ...
      <div class="col-md-3">
        <div class="process-step p-3">
          ...
          <h6 class="fw-bold mt-3">Diagnosis</h6>
      ...
      <div class="col-md-3">
        <div class="process-step p-3">
          ...
          <h6 class="fw-bold mt-3">Repair</h6>
