...
<main>
  <section class="appointment-section d-flex align-items-center font-ui">
  <div class="container ">
    <div class="row justify-content-center">
      <div class="col-lg-6 col-md-8 slide-right">
        
        <div class="appointment-card p-4 p-md-5">
          <h2 class="text-center mb-4 fw-bold">Get Free Appointment</h2>
@if(session('success'))
...
@csrf
  ...
  <div class="mb-2">
   <label class="form-label fw-semibold">Services</label>
    <select name="service" class="form-control custom-input" required>
  ...
  <div class="mb-2">
    ...
    <input type="text" name="location" class="form-control custom-input" required>
  </div>

  <div class="mb-2">
    <label class="form-label fw-semibold">Time Required</label>
    <select name="time" class="form-control custom-input" required>
  ...
  <button class="btn submit-btn w-100">Book Appointment</button>

</form>

<script>
  function handleLocationChange(select) {
    const manualInput = document.getElementById('locationManual');
...
<section class="modern-faq py-5 slide-left">
  <div class="container">
