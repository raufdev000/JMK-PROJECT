    ...
    <div class="container">
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-6 order-lg-1 order-2">
                <h1 class="hero-title mb-4">Lost Car Key? <span class="text-warning">We're Here 24/7!</span></h1>
                <p class="hero-subtitle mb-4">Emergency Car Locksmith Service in Dubai - Fast, Professional & Available Anytime</p>
...
<img src="https://images.unsplash.com/photo-1617469767053-d3b523a0b982?w=800&h=600&fit=crop" ...
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="services-section font-ui">
        <div class="container">
            <div class="section-title">
                <h2>Our Car Key Services in Dubai</h2>
                <div class="underline"></div>
                <p class="text-muted">Complete automotive locksmith solutions for all your car key emergencies</p>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <h4>Lost Car Key Replacement</h4>
                        <p>Lost your car keys completely? We create new keys on the spot for all car brands including Toyota, Honda, BMW, Mercedes, Nissan, and more. No need to tow your car - we come to you anywhere in Dubai.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <h4>Car Door Unlocking Service</h4>
                        <p>Locked your keys inside the car? Our expert technicians unlock any car door without damage using professional tools. Works for all vehicles - sedans, SUVs, trucks, and luxury cars.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <h4>Car Key Duplication Dubai</h4>
                        <p>Need spare keys? We duplicate all types of car keys including traditional keys, transponder keys, remote keys, and smart keys. Get backup keys made while you wait.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <p>Key broke in the ignition or door lock? We safely extract broken keys from ignitions, door locks, and trunk locks without damaging your vehicle. Then we create a new key immediately.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <h4>Key Programming & Coding</h4>
                        <p>We program and code transponder keys, remote keys, and smart keys for all car models. Our advanced equipment ensures your new key works perfectly with your car's security system.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="service-card">
                        ...
                        <h4>Ignition Repair & Replacement</h4>
                        <p>Ignition cylinder problems? We repair and replace faulty ignitions on-site. If your key won't turn or gets stuck, we fix it fast so you can get back on the road.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="key-types-section font-ui">
        <div class="container">
            <div class="section-title">
                <h2>We Handle All Types of Car Keys</h2>
                <div class="underline"></div>
                <p class="text-muted">From basic keys to advanced smart keys - we repair, replace, and duplicate everything</p>
            </div>
            
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="key-type-card">
                        <h5><i class="bi bi-key-fill"></i> Traditional Keys</h5>
                        <ul>
                            <li>Standard metal keys</li>
                            <li>Basic car keys</li>
                            <li>Vintage car keys</li>
                            <li>Classic vehicle keys</li>
                            <li>Duplicate within minutes</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="key-type-card">
                        <h5><i class="bi bi-broadcast"></i> Transponder Keys</h5>
                        <ul>
                            <li>Chip keys</li>
                            <li>Programmed transponders</li>
                            <li>Immobilizer keys</li>
                            <li>Security chip keys</li>
                            <li>Full programming service</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="key-type-card">
                        <h5><i class="bi bi-phone"></i> Remote Keys</h5>
                        <ul>
                            <li>Remote control keys</li>
                            <li>Key fobs</li>
                            <li>Button keys</li>
                            <li>Flip keys</li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="key-type-card">
                        <h5><i class="bi bi-tablet"></i> Smart Keys</h5>
                        <ul>
                            <li>Proximity keys</li>
                            <li>Push-button start keys</li>
                            <li>Keyless entry cards</li>
            ...
            <div class="text-center mt-5 font-ui">
                <p class="text-muted mb-3"><strong>All Car Brands Supported:</strong></p>
                <p class="text-muted">Toyota • Honda • Nissan • BMW • Mercedes-Benz • Audi • Lexus • Ford • Chevrolet • Hyundai • Kia • Mazda • Volkswagen • Porsche • Range Rover • Jaguar • Tesla • And More!</p>
            </div>
        </div>
    </section>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="location-card">
                        ...
                        <p class="mb-4">Your trusted car locksmith located in the heart of Al Karama, serving all of Dubai 24/7</p>
    ...
    <section class="why-choose-section font-ui">
        <div class="container">
            <div class="section-title">
                <h2>Why Choose Our Car Locksmith Service?</h2>
                <div class="underline"></div>
            </div>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box">
                        ...
                        <p>Our mobile units reach your location fast. Quick arrival means you're back on the road sooner.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box">
                        ...
                        <p>Highly trained and certified automotive locksmiths with years of experience handling all car brands.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box">
                        ...
                        <p>Professional tools and techniques ensure your vehicle remains undamaged during any service.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box">
                        ...
                        <p>All services performed at your location - home, office, parking lot, or roadside. No towing needed.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box">
                        ...
                        <p>Thousands of happy customers across Dubai trust us for their car key emergencies.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="feature-box">
                        ...
                        <p>State-of-the-art equipment for key cutting, programming, and unlocking all modern vehicles.</p>
                    </div>
                </div>
            </div>
        </div>
